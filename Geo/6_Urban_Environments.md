...
# Case Study
## Hong Kong
![hong_kong](.src/hong_kong1.png)
- land area of just over 1000 square km
- population of over 7 million
- Economy:
	- benefited from globalization
	- economic development based on trade and financial services
	- manufacturing has never been a major part of the economy so de-industralization did not affect Hong Kong much
	- world's largest re-export center
		- re-exports are products are products made outside territory, especially in mainland China, which are distributed via Hong Kong
	- has few natural resources
- Food:
	- little arable land
		- agriculture is a relatively unimportant part of the economy and only contributes only 0.1 percent of its GDP
		- has to import most of its food
- Energy:
	- mainly in the form of electricity
	- around 75 percent of this generated by the burning of fossil fuels
	- nearly quarter of the electricity is generated by nuclear power
	- most imported from mainland China
- Transport:
	- traffic congestion is main issue
	- well-developed transport network and movement around densely populated territory is relatively easy
	- over 90 percent of 11 million journeys made every day are on public transport
- Social:
	- provides good social services, particularly education and healthcare
- Housing:
	- one of the world's most densely packed places
	- only way to grow is upwards, become 'vertical city'
	- half of Hong Kong's residents live in public housing, rented from the government
	- ranked third most expensive city in the world
	- reduced social mobility - extremely difficult for people to move from the public to the private sector
	- social polarization: extreme wealth, as well as poverty and deprivation are found in the compact area
	- ethnic segregation:
		- 94 percent Chinese
		- 6 percent up mainly of Philippines
	- Also Britons, Americans, Canadians, Japanese and Koreans living in Hong Kong
		- they work in city's commercial and financial sector and live in the wealthier districts
- Poverty and Deprivation
	- contains pockets of poverty and deprivation
	- slums:
		- there were slums in Kowloon City, but they were cleared away in 1990s
		- today, slums are found on rooftops
		- known as 'penthouse slums' or 'rooftop of shanty towns'

![hong_kong](.src/hong_kong2.png)

- Environmental:
	- Ecological footprint due to:
		- burning of large amounts of fossil fuels
		- need to reclaim large amounts of land from the sea to create new space for urban growth
		- disposal of waste
		- smog that drifts across the territory from industrial developments on the other side of the Pearl River delta
		- water supply:
			- few rivers and lakes
			- groundwater sources are difficult to access
			- 70 percent of water supply from Dongjiang River in mainland China
		- Waste Disposal:
			- Hong Kong's 11 million residents produce an estimated 6.4 million tonnes of waste a year
			- attempting to recycle

![hong_kong](.src/hong_kong3.png)

![hong_kong](.src/hong_kong4.png)
...
- started in 2008 to build one of the world's most sustainable city
- nearing completion to house 40,000 people and 5000 people to commute and work
- based on reducing consumption of energy and water, and reducing the production of waste
	- all energy supply renewable
	- nearly all come from solar panels
	largest photovoltaic plants in the Middle East
	- design of streets makes good use of coolness provided by prevailing winds
	- orientation of buildings and their design minimize need for air conditioning

![masdar](.src/masdar2.png)

- installed smart water consumption system in all the city's buildings
	- designed to consume 54 percent less water than the UAE's average building
	- 75 percent of hot water provided via thermal receptors fixed on top of buildings
- Waste reduced as near as possible to zero
	- encourage changes in behavior
	- controlling types of materials used within the city
	- citizens required to attend five hours of sustainability education each year
- leader in research and education in sustainable and clean technologies
- two limitations:
	- large sums of capital needed to set up
	- only suitable for those parts of the world with access to plentiful supply of renewable energy

![masdar](.src/masdar1.png)

## Curitiba, Brazil
- population well over 2 million in south-west Brazil

![curitiba](.src/curitiba2.png)

- Curitiba Master Plan first aimed at improving transport
	- five main roads converging on city center converted into dual carriageway separated by a central two lane carriageway exclusive use by express buses
	- triple articulated buses provide fast, efficient and cheap transport
	- network now used by 70 percent of city's inhabitants

![crutiba](.src/curitiba1.png)

- town surrounded by parks for public recreation
	- stops shanty towns being established on the urban fringe
	- lakes created within parks prevent flooding
	- grass controlled by grazing sheep
- city recycles its waste and has done so since 1980:
	- recycles over two-thirds of its waste
	- people paid for garbage they collected with fruits and vegetables (not money)
	- very effective in improving conditions of slums
- 99 percent of Curitiba's residents are happy with the city



## Urban Gardens, Afghanistan
- urban areas provide refuge for large numbers of Afghans forced to leave their homes in mainly rural areas
	- driven out by armed conflict, natural disasters and lack of economic opportunities
- but resetting in cities do not bring an end to poverty and despair
	- added problem is adjusting to unfamiliar environment
	- challenge:
		- making sustainable living for themselves
		- ensuring that they do not reduce existing sustainability of towns and cities which tehy set up their new homes
![urban_gardens](.src/urban_gardens1.png)
- Schemes started by People in Need and funded by EU and Czech Development Agency is being trialled in Mazar-i-Sharif
	- city in northern Afghanistan
		- Raising food production from small plots attached to most dwellings
			- training given in:
				- basic crop growing
				- rainwater harvesting
				- constructing simple greenhouses
				- storage of harvested vegetables
			- most of food is consumed by the family
			- surplus can be sold in markets			
		- setting up female self-help groups and training in basic skills as well as informing them about nutrition and hygiene
			- help of micro loans to start new businesses
			- allow for:
				- shops
				- spinning
				- making clothes
				- rearing poultry
	- all helping empower women

![urban_gardens](.src/urban_gardens2.png)

- Mazard-i-Sharif project provides a possible model
for other urban areas in Afghanistan
- helping to remedy food insecurity, unemployment and poverty
- making urban areas less reliant on food from rural
areas
- also making urban areas more self-sufficient and, as a result, a little more sustainable.
